  ...
  return (
    <div className="bg-white dark:bg-gray-900 min-h-screen pt-14 lg:pl-60">
      <div className="px-6 py-6">
        ...
        <h1 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">{genre} Films</h1>
        ...
        {films.length > 0 ? (
          ...
          <div className="text-center py-20">
            <p className="text-gray-600 dark:text-gray-400">No {genre} films available</p>
          </div>
        )}
      </div>
    </div>
